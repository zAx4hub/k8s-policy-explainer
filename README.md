# K8s Policy Explainer

> Explain Kyverno and OPA denials in plain English

**Author:** zAx4hub

## Problem

Explain Kyverno and OPA denials in plain English. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`k8s-policy-explainer` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **parser** engine, CLI, examples, and tests.
